import{a as h,i as g}from"./vendor-Cbhu4xvy.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))a(r);new MutationObserver(r=>{for(const i of r)if(i.type==="childList")for(const n of i.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&a(n)}).observe(document,{childList:!0,subtree:!0});function s(r){const i={};return r.integrity&&(i.integrity=r.integrity),r.referrerPolicy&&(i.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?i.credentials="include":r.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function a(r){if(r.ep)return;r.ep=!0;const i=s(r);fetch(r.href,i)}})();const V="https://your-energy.b.goit.study/api",ie={mobile:9,tablet:12,desktop:12},ne={mobile:8,tablet:10,desktop:10};h.defaults.baseURL=V;const oe=(t,e,s)=>{const a={filter:t,page:e,limit:s};return h.get("/filters",{params:a})},ce=t=>h.get(`/exercises/${t}`),le=t=>h.get("/exercises",{params:t}),de=(t,e,s,a)=>{const r={rate:e,email:s,review:a};return h.patch(`/exercises/${t}/rating`,r)},m="/your-energy/assets/sprite-D8xu5p1j.svg",ue="/your-energy/assets/no-image-B2yyVwMF.jpg";function me(t,e){const s="#EEA10C",a="#F4F4F4";let i="";for(let n=0;n<5;n++){const d=`starGradient${n}`,o=n+1<=t?100:n<t?t%1*100:0,l=[{offset:"0%",color:s,opacity:"1"},{offset:`${o}%`,color:s,opacity:"1"},{offset:`${o+1}%`,color:a,opacity:"0.20"}],u=`
            <linearGradient id="${d}" x1="0%" y1="0%" x2="100%" y2="0%">
              ${l.map(p=>`<stop offset="${p.offset}" style="stop-color:${p.color};stop-opacity:${p.opacity}" />`).join("")}
            </linearGradient>
...
//# sourceMappingURL=main-BEXj5-cW.js.map
